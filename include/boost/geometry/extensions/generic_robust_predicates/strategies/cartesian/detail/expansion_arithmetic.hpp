                                ...
                                OutIter)
{
    ...
    bool advance =
        expansion_sum_advance<zero_elimination, NegateE, NegateF>(*e_begin,
                                                                  *f_it);
    ...
    {
        advance =
            expansion_sum_advance<zero_elimination, false, NegateF>(*h_begin_i,
                                                                    *f_it);
        h_it = grow_expansion
            <
                zero_elimination,
...
<
    ...
    bool inplace
>
constexpr OutIter fast_expansion_difference(InIter1 e_begin,
                                            InIter1 e_end,
                                            InIter2 f_begin,
                                            InIter2 f_end,
                                            OutIter h_begin,
